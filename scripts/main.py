...
def load_variables(config_file="config.yaml"):
    ...
    if not ai_goals:
        ...
        print(
            "For example: \nIncrease net worth, Grow Twitter Account, Develop and"
            " manage multiple businesses autonomously'"
        )
...
def prompt_user():
    ...
    if ai_role == "":
        ai_role = (
            "an AI designed to autonomously develop and run businesses with the sole"
            " goal of increasing your net worth."
        )
    ...
    if args.continuous:
        ...
        print_to_console(
            ...
            (
                ...
                " usually authorise. Use at your own risk."
            ),
        )
...
while True:
    ...
    if not cfg.continuous_mode:
        ...
        print_to_console(
            ...
            Fore.CYAN,
            (
                f"COMMAND = {Fore.CYAN}{command_name}{Style.RESET_ALL}  ARGUMENTS ="
                f" {Fore.CYAN}{arguments}{Style.RESET_ALL}"
            ),
        )
